...
namespace EquipmentGen.Tests.Unit.Common.Items
{
    ...
    public class PotionConstantsTests
    {
        ...
        [TestCase(PotionConstants.MagicCircleAgainstALIGNMENT, "Potion of magic circle against ALIGNMENT")]
        ...
        [TestCase(PotionConstants.ProtectionFromALIGNMENT, "Potion of protection from ALIGNMENT")]
