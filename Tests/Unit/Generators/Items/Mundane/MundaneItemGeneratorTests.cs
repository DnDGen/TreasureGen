...
namespace EquipmentGen.Tests.Unit.Generators.Items.Mundane
{
    ...
    public class MundaneItemGeneratorTests
    {
        ...
        public void Setup()
        {
            ...
            mockPercentileResultProvider.Setup(p => p.SelectFrom("MundaneItems", 9266)).Returns(ItemTypeConstants.AlchemicalItem);
        ...
        public void MundaneItemGeneratorProducesArmor()
        {
            ...
            mockPercentileResultProvider.Setup(p => p.SelectFrom("MundaneItems", 9266)).Returns(ItemTypeConstants.Armor);
        ...
        public void MundaneItemGeneratorProducesWeapons()
        {
            ...
            mockPercentileResultProvider.Setup(p => p.SelectFrom("MundaneItems", 9266)).Returns(ItemTypeConstants.Weapon);
        ...
        public void MundaneItemGeneratorProducesTools()
        {
            ...
            mockPercentileResultProvider.Setup(p => p.SelectFrom("MundaneItems", 9266)).Returns(ItemTypeConstants.Tool);
