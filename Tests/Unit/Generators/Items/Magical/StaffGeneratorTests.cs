...
namespace EquipmentGen.Tests.Unit.Generators.Items.Magical
{
    ...
    public class StaffGeneratorTests
    {
        ...
        {
            mockPercentileSelector.Setup(s => s.SelectFrom("powerStaves")).Returns("staffiness");
            var staff = staffGenerator.GenerateAtPower("power");
        ...
        {
            mockPercentileSelector.Setup(s => s.SelectFrom("powerStaves")).Returns("Power");
            var staff = staffGenerator.GenerateAtPower("power");
        ...
        public void StaffOfPowerHasQuarterstaffAttributes()
        {
            ...
            mockAttributesSelector.Setup(s => s.SelectFrom("WeaponAttributes", WeaponConstants.Quarterstaff)).Returns(attributes);
