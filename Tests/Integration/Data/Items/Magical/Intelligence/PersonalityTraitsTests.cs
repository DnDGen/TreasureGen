...
namespace EquipmentGen.Tests.Integration.Tables.Items.Magical.Intelligence
{
    ...
    public class PersonalityTraitsTests : PercentileTests
    {
        ...
        [TestCase("Unpleasant odor when item communicates", 4)]
        [TestCase("Strong, unpleasant, unwavering odor", 5)]
        [TestCase("Pleasant smelling (perfumed)", 6)]
        [TestCase("Slippery", 7)]
        [TestCase("Vibrates lightly when wielded", 8)]
        [TestCase("Unusual-colored markings", 9)]
        [TestCase("Sputters", 10)]
        ...
        {
            AssertPercentile(String.Empty, 26);
        }
    }
}