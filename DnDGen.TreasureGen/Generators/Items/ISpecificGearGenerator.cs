...
namespace DnDGen.TreasureGen.Generators.Items
{
    ...
    {
        Item GeneratePrototypeFrom(string power, string specificGearType, string name, params string[] traits);
        ...
        bool IsSpecific(string power, string specificGearType, string itemName);
