...
namespace EquipmentGen.Core.Data.Items.Constants
{
    public static class ArmorConstants
    {
        ...
        public const String MithralShirt = "Mithral shirt";
        public const String DragonhidePlate = "Dragonhide plate";
        public const String ElvenChain = "Elven chain";
        public const String RhinoHide = "Rhino hide";
        public const String AdamantineBreastplate = "Adamantine breastplate";
        ...
        public const String MithralFullPlateOfSpeed = "Mithral full plate of speed";
        public const String DemonArmor = "Demon armor";
        public const String DarkwoodBuckler = "Darkwood buckler";
        public const String DarkwoodShield = "Darkwood shield";
        public const String MithralHeavyShield = "Mithral heavy shield";
