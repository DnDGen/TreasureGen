...
namespace DnDGen.TreasureGen.Tests.Integration.Tables.Items.Levels
{
    ...
    public class Level29ItemsTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(PowerConstants.Medium, AmountConstants.Range1d4, 1, 17)]
        [TestCase(PowerConstants.Major, AmountConstants.Range1d3, 18, 70)]
        [TestCase(PowerConstants.Major, AmountConstants.Range1d3Plus31, 71, 100)]
