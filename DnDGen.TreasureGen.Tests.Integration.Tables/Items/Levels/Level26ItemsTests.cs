...
namespace DnDGen.TreasureGen.Tests.Integration.Tables.Items.Levels
{
    ...
    public class Level26ItemsTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(PowerConstants.Medium, AmountConstants.Range1d4, 1, 20)]
        [TestCase(PowerConstants.Major, AmountConstants.Range1d3, 21, 73)]
        [TestCase(PowerConstants.Major, AmountConstants.Range1d3Plus12, 74, 100)]
