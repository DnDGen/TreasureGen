...
namespace DnDGen.TreasureGen.Tests.Unit.Selectors.Collections
{
    ...
    public class WeaponDataSelectorTests
    {
        ...
        public void GetWeaponData()
        {
            ...
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Gargantuan][0].ToString(), Is.EqualTo("way too much emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Huge], Has.Count.EqualTo(1));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Huge][0].ToString(), Is.EqualTo("a ton emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Large], Has.Count.EqualTo(1));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Large][0].ToString(), Is.EqualTo("quite a bit emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Medium], Has.Count.EqualTo(1));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Medium][0].ToString(), Is.EqualTo("a normal amount emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Small], Has.Count.EqualTo(1));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Small][0].ToString(), Is.EqualTo("a little emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Tiny], Has.Count.EqualTo(1));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Tiny][0].ToString(), Is.EqualTo("almost nothing emotional"));
            ...
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Colossal][0].ToString(), Is.EqualTo("DAYUM but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Gargantuan], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Gargantuan][0].ToString(), Is.EqualTo("way too much but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Huge], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Huge][0].ToString(), Is.EqualTo("a ton but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Large], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Large][0].ToString(), Is.EqualTo("quite a bit but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Medium], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Medium][0].ToString(), Is.EqualTo("a normal amount but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Small], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Small][0].ToString(), Is.EqualTo("a little but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Tiny], Has.Count.EqualTo(1));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Tiny][0].ToString(), Is.EqualTo("almost nothing but more emotional"));
        ...
        public void GetWeaponData_MultipleDamages()
        {
            ...
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Gargantuan][0].ToString(), Is.EqualTo("way too much emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Gargantuan][1].ToString(), Is.EqualTo("far too much spiritual"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Huge], Has.Count.EqualTo(2));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Huge][0].ToString(), Is.EqualTo("a ton emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Huge][1].ToString(), Is.EqualTo("a truckload spiritual"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Large], Has.Count.EqualTo(2));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Large][0].ToString(), Is.EqualTo("quite a bit emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Large][1].ToString(), Is.EqualTo("quite a lot spiritual"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Medium], Has.Count.EqualTo(2));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Medium][0].ToString(), Is.EqualTo("a normal amount emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Medium][1].ToString(), Is.EqualTo("a standard amount spiritual"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Small], Has.Count.EqualTo(2));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Small][0].ToString(), Is.EqualTo("a little emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Small][1].ToString(), Is.EqualTo("a bit spiritual"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Tiny], Has.Count.EqualTo(2));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Tiny][0].ToString(), Is.EqualTo("almost nothing emotional"));
            Assert.That(selection.DamagesBySize[TraitConstants.Sizes.Tiny][1].ToString(), Is.EqualTo("sort of nothing spiritual"));
            Assert.That(selection.DamagesBySize.Count, Is.EqualTo(7));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Colossal], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Colossal][0].ToString(), Is.EqualTo("DAYUM but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Colossal][1].ToString(), Is.EqualTo("OHLAWDITCOMIN' but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Gargantuan], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Gargantuan][0].ToString(), Is.EqualTo("way too much but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Gargantuan][1].ToString(), Is.EqualTo("far too much but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Huge], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Huge][0].ToString(), Is.EqualTo("a ton but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Huge][1].ToString(), Is.EqualTo("a truckload but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Large], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Large][0].ToString(), Is.EqualTo("quite a bit but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Large][1].ToString(), Is.EqualTo("quite a lot but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Medium], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Medium][0].ToString(), Is.EqualTo("a normal amount but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Medium][1].ToString(), Is.EqualTo("a standard amount but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Small], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Small][0].ToString(), Is.EqualTo("a little but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Small][1].ToString(), Is.EqualTo("a bit but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Tiny], Has.Count.EqualTo(2));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Tiny][0].ToString(), Is.EqualTo("almost nothing but more emotional"));
            Assert.That(selection.CriticalDamagesBySize[TraitConstants.Sizes.Tiny][1].ToString(), Is.EqualTo("sort of nothing but more spiritual"));
            Assert.That(selection.CriticalDamagesBySize.Count, Is.EqualTo(7));
        }
    }
}
